...
/**
 * @route /supplier/* (error boundary)
 * @description Catches unhandled errors in any supplier portal route.
 */
    ...
    <div className="min-h-screen bg-surface flex items-center justify-center px-8">
      <div className="max-w-md text-center">
        ...
        <p className="font-body-md text-body-md text-on-surface-variant mb-2">
          An error occurred while loading the supplier portal.
        </p>
        {error.digest && (
        ...
        <div className="flex gap-3 justify-center mt-6">
          ...
          <Link href="/" className="border border-outline-variant text-on-surface-variant font-label-md text-label-md px-6 py-2.5 rounded hover:bg-surface-container transition-colors">
            Go home
          </Link>
        </div>
      </div>
